...
class EmbeddingsResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> EmbeddingsResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/relax-ai/python-sdk-test#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> EmbeddingsResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/relax-ai/python-sdk-test#with_streaming_response
        """
