...
class HealthResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> HealthResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/relaxai-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> HealthResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/relaxai-python#with_streaming_response
        """
